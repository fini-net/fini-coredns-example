...
- The zone files are build with `dnscontrol`
- Container built to serve the zones with `coredns`.
- Container available in GHCR
- Test suite to verify success of container
